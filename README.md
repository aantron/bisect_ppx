# Bisect_ppx &nbsp; [![version 2.0.0][version]][releases] [![Travis status][travis-img]][travis] [![AppVeyor status][appveyor-img]][appveyor] [![Coverage][coveralls-img]][coveralls]
...
| GH Actions | `github`         | `$GITHUB_RUN_NUMBER` |
