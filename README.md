# Bisect_ppx &nbsp; [![version 2.0.0~dev0][version]][releases] [![Travis status][travis-img]][travis] [![AppVeyor status][appveyor-img]][appveyor] [![Coverage][coveralls-img]][coveralls]
...
[version]: https://img.shields.io/badge/version-2.0.0~dev0-blue.svg
...
Travis and CircleCI. To do this, run
