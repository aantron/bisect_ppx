...
See instructions in the [bisect_ppx-ocamlbuild](https://github.com/aantron/bisect_ppx-ocamlbuild#using-with-ocamlbuild) repository.

<a id="OASIS"></a>
#### With OASIS

See instructions in the [bisect_ppx-ocamlbuild](https://github.com/aantron/bisect_ppx-ocamlbuild#using-with-oasis) repository.
